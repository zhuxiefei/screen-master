...
public class HttpClientUtil {
     ...
     * @return
     */
    public static Response post(String apiUrl, JSONObject json, HttpServletRequest request) {
        ...
        try {
            ...
            if (null != request) {
                httpPost.setHeader("userId", request.getHeader("userId"));
                httpPost.setHeader("token", request.getHeader("token"));
                httpPost.setHeader("estateId",request.getHeader("estateId"));
            }
        ...
        Response resp = GsonUtil.gson2Object(httpStr, Response.class);
        return resp;
    }
