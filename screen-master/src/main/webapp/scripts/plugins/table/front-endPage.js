;(function($, window, document,undefined) {
    ...
    cjjTable.prototype = {
        start:function(){
            ...
            var json = "";
            var maxpagenumberBox = 3;//选择项最多的数量
            ...
            if(firstPageNumber==0){
                histroy_DDBox="<tr><td></td><td>没有数据</td></tr>";
            }
            ...
            var buttonTfoot = "<tr>"+
                ...
                "<span class='firstPage' style='margin-right:10px;cursor: pointer;float:left;display: none;margin-left:10px;height:26px'>首页</span>"+
                "<span class='lastPage' style='margin-right:10px;cursor: pointer;float:left;display: none;height:26px'>上一页</span>"+
                ...
                "<span class='nextPage' style='margin-right:10px;float:left;cursor: pointer;height:26px'>下一页</span>"+
                "<span class='endPage' style='cursor: pointer;float:left;height:26px'>尾页</span>"+
                "</div>"+
                "<div style='float:right'>"+
        ...
        page:function(Pagenumber, pageNUmber, maxpagenumberBox,json,that,e) {
            ...
            // $('input#allSeleted').attr('checked', false).iCheck('uncheck');
            if(count==checkCount){
